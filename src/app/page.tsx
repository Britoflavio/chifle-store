  ...
  return (
    <main className="shell">
      ...
      <header className="nav">
        ...
        <div className="nav-actions"><Link className="nav-action" href="/admin">Admin</Link><button className="cart-button" onClick={() => setCartOpen(true)} aria-label={`Abrir carrito, ${cartCount} productos`}>Carrito <span className="cart-count">({cartCount.toString().padStart(2, "0")})</span></button></div>
      </header>
